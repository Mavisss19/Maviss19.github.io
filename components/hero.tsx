...
import { CheckCircle, Star, Users, Clock, Award, Shield } from "lucide-react"
            ...
            <div className="bg-white rounded-3xl p-8 shadow-2xl border border-gray-100 relative z-10">
              ...
              <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-xl p-4 border border-green-200">
                <div className="flex items-center justify-between">
                  <div>
                    <div className="text-sm font-semibold text-green-700 mb-1">🎉 Promo Spesial</div>
                    <div className="text-lg font-bold text-gray-900">Konsultasi Gratis + Diskon 10%</div>
                    <div className="text-sm text-gray-600">Untuk 50 pelanggan pertama bulan ini</div>
                  </div>
